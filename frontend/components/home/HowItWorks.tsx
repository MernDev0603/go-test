...
const data = [
  {
    title: 'Sign up',
    description: 'Start by signing up for a free SearchWithText account',
    image: '/pen.png',
  },
  {
    title: 'Upload a TXT',
    description: 'After login, upload your Text and let the AI tool analyze it',
    image: '/upload.png',
  },
  {
    title: 'Begin Chatting',
    description: 'Simply start asking the AI any question about the Text!',
    image: '/chat.png',
  },
];
